 /*Crie uma classe Personagem seguindo todas as regras apresentadas no slide unidade01g_conceitosBasicos_introducaoOO.pdf.
    ...
    import java.text.DateFormat;
        ...
        public class Personagem {
            ...
            public static Personagem comparaPorId(String myId,ArrayList<Personagem> personagem){
            ...
            public static Personagem buscaPorNome(String name,ArrayList<Personagem> personagem){
                Personagem newPersonagem = null;              
                  for(Personagem p : personagem  ){
                    if(p.getName().equals(name)){
                        newPersonagem = clone(p);
                        continue;
                    }
                }
                return newPersonagem;
            }
            public static void comparaIdNome(ArrayList<Personagem> personagem,ArrayList<Personagem> personagem2){
            ...
            public static void main(String[] args) throws ParseException {
                ...
                ArrayList<Personagem> NewPersonagem1 = new ArrayList<Personagem>();
                ArrayList<Personagem> NewPersonagem2 = new ArrayList<Personagem>();

                // printaArray(personagem);
                String myId;
                String name;
                    while(!(myId = scanner.nextLine()).equals("FIM")){
                        if(comparaPorId(myId, personagem) == null)continue;
                          NewPersonagem1.add(comparaPorId(myId, personagem));
                    }
                    while(!(name = scanner.nextLine()).equals("FIM")){
                        if(buscaPorNome(name, personagem) == null) continue;
                          NewPersonagem2.add(buscaPorNome(name, personagem));
                    }
                    comparaIdNome(NewPersonagem2, NewPersonagem1);
