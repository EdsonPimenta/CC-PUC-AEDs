...
class Personagem {
    ...
    public static void printaArray(Personagem[] personagem,Lista lista) {
        for (int i=0; i< lista.getN(); i++) {
            personagem[i].printPersonagem(i);
        }
...
class Lista {
    ...
    Lista(ArrayList<Personagem> personagem) {
    ...
    public void InserirInicio(Personagem personagem) {
        for (int i = n; i > 0; i--) {
            this.personagemArr[i] = personagemArr[i - 1];
        }
        personagemArr[0] = personagem;
        n++;
    }
    ...
    public void inserir(int pos, Personagem personagem) {
        for (int i = n; i > pos; i--) {
            personagemArr[i] = personagemArr[i - 1];
        }
        this.personagemArr[pos] = personagem;
        n++;
    }
    ...
    public Personagem removerInicio() {
        ...
        Personagem temp = personagemArr[0];
        for (int i = 0; i < n - 1; i++) {
            this.personagemArr[i] = personagemArr[i + 1];
        }
        n--;
    ...
    public Personagem remover(int pos) {
        Personagem temp = personagemArr[pos];
    ...
    public void mostrar(Lista lista) {
        Personagem.printaArray(personagemArr,lista);
    }
...
public class Main {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Lista lista = new Lista(subList1);
