...
//  --------------------------------------------Ordenacao ---------------------------------------------
    ...
    class ArvoreBinaria {
        ...
        private No inserir(No no, Personagem personagem) {
            if (no == null) {
                no = new No(personagem);
            } else if (personagem.getName().compareTo(no.personagem.getName()) < 0) {
        ...
        private boolean pesquisar(No no, String nome, StringBuilder caminho) {
            if (no == null) {
                return false;
        ...
        public void lerId(Scanner scanner,ArrayList<Personagem> personagens){
            String entradaInsercao = new String();
            while (!(entradaInsercao = scanner.nextLine()).equals("FIM")) {
                for (Personagem personagem : personagens) {
                    if (personagem.getId().equals(entradaInsercao)) {
                        inserir(personagem);
                        break;
                    }
                }
        ...
        public void lerNomes(Scanner scanner,ArrayList<Personagem> personagens){
            String entradaPesquisa;
            while (!(entradaPesquisa = scanner.nextLine()).equals("FIM")) {
                String nomePesquisa = entradaPesquisa;
                StringBuilder caminho = new StringBuilder();
                boolean encontrado = pesquisar(nomePesquisa, caminho);
                if (encontrado) {
                    caminho.append(" SIM");
                } else {
                    caminho.append(" NAO");
                }
                System.out.println(nomePesquisa + " => raiz" + caminho.toString());
            }
    ...
    public class Main {
        ...
        public static void main(String[] args) throws ParseException {
            ...
            // Inserção dos personagens na árvore binária
            arvore.lerId(scanner, personagens);
            arvore.lerNomes(scanner, personagens);
